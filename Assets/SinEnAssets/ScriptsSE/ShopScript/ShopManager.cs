...
public class ShopManager : MonoBehaviour
{
    ...
    [Header("UI References - MUST BE SET WHEN SHOP OPENS")]
    [Tooltip("Set this via FindUIReferences() when shop opens")]
    private Transform shopItemContent;
    [Tooltip("Assign the prefab in Inspector")]
    public GameObject shopItemPrefab;
    [Tooltip("Set this via FindUIReferences() when shop opens")]
    private TextMeshProUGUI playerCoinsText;

    [Header("Feedback Panels - Set when shop opens")]
